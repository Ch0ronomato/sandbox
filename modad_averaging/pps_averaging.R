...
if(nrow(log_data) != length(tree_file)) stop('The tres and log file have different number of samples')
...
test_50_sims <- pps_test(log_data, tree_data, seq_data, nsims = 50)
